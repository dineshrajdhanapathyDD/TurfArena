...
export function OrganizerLayout({ children, title, subtitle, selectedPeriod, onPeriodChange }: OrganizerLayoutProps) {
  const { user } = useAuth()
  ...
  const sidebarItems: SidebarItem[] = useMemo(() => [
    { label: 'Dashboard', href: '/organizer', icon: Trophy },
    { label: 'Tournaments', href: '/organizer/tournaments', icon: Calendar },
    { label: 'Teams', href: '/organizer/teams', icon: Users },
    { label: 'Analytics', href: '/organizer/analytics', icon: TrendingUp },
    { label: 'Revenue', href: '/organizer/revenue', icon: DollarSign },
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <button
                ...
                className="w-8 h-8 rounded-full bg-gradient-to-br from-purple-500 to-pink-600 flex items-center justify-center cursor-pointer hover:shadow-lg hover:shadow-purple-500/50 transition-all"
              >
